...
pub const map = struct {
    // TODO: make each impl file a struct to stop 'ACTI.ACTI' idiocy
    ACTI: std.StringArrayHashMapUnmanaged(impl.ACTI.ACTI) = .{},
    ALCH: std.StringArrayHashMapUnmanaged(impl.ALCH.ALCH) = .{},
    APPA: std.StringArrayHashMapUnmanaged(impl.APPA.APPA) = .{},
    ARMO: std.StringArrayHashMapUnmanaged(impl.ARMO.ARMO) = .{},
    BODY: std.StringArrayHashMapUnmanaged(impl.BODY.BODY) = .{},
    BOOK: std.StringArrayHashMapUnmanaged(impl.BOOK.BOOK) = .{},
    BSGN: std.StringArrayHashMapUnmanaged(impl.BSGN.BSGN) = .{},
    CELL: impl.CELL.cell_data = .{},
    CLAS: std.StringArrayHashMapUnmanaged(impl.CLAS.CLAS) = .{},
    CLOT: std.StringArrayHashMapUnmanaged(impl.CLOT.CLOT) = .{},
    CONT: std.StringArrayHashMapUnmanaged(impl.CONT.CONT) = .{},
    CREA: std.StringArrayHashMapUnmanaged(impl.CREA.CREA) = .{},
    DIAL: std.StringArrayHashMapUnmanaged(impl.DIAL.DIAL) = .{},
    DOOR: std.StringArrayHashMapUnmanaged(impl.DOOR.DOOR) = .{},
    ENCH: std.StringArrayHashMapUnmanaged(impl.ENCH.ENCH) = .{},
    FACT: std.StringArrayHashMapUnmanaged(impl.FACT.FACT) = .{},
    GLOB: std.StringArrayHashMapUnmanaged(impl.GLOB.GLOB) = .{},
    GMST: std.StringArrayHashMapUnmanaged(impl.GMST.GMST) = .{},
    INGR: std.StringArrayHashMapUnmanaged(impl.INGR.INGR) = .{},
    LAND: std.AutoArrayHashMapUnmanaged(u64, impl.LAND.LAND) = .{},
    LEV_: std.StringArrayHashMapUnmanaged(impl.LEV_.LEV_) = .{},
    LIGH: std.StringArrayHashMapUnmanaged(impl.LIGH.LIGH) = .{},
    LOCK: std.StringArrayHashMapUnmanaged(impl.LOCK.LOCK) = .{},
    LTEX: std.StringArrayHashMapUnmanaged(impl.LTEX.LTEX) = .{},
    MGEF: std.AutoArrayHashMapUnmanaged(u32, impl.MGEF.MGEF) = .{},
    MISC: std.StringArrayHashMapUnmanaged(impl.MISC.MISC) = .{},
    NPC_: std.StringArrayHashMapUnmanaged(impl.NPC_.NPC_) = .{},
    PGRD: impl.PGRD.pgrd_data = .{},
    PROB: std.StringArrayHashMapUnmanaged(impl.PROB.PROB) = .{},
    RACE: std.StringArrayHashMapUnmanaged(impl.RACE.RACE) = .{},
    REGN: std.StringArrayHashMapUnmanaged(impl.REGN.REGN) = .{},
    REPA: std.StringArrayHashMapUnmanaged(impl.REPA.REPA) = .{},
    SCPT: std.StringArrayHashMapUnmanaged(impl.SCPT.SCPT) = .{},
    SKIL: std.AutoArrayHashMapUnmanaged(u32, impl.SKIL.SKIL) = .{},
    SNDG: std.StringArrayHashMapUnmanaged(impl.SNDG.SNDG) = .{},
    SOUN: std.StringArrayHashMapUnmanaged(impl.SOUN.SOUN) = .{},
    SPEL: std.StringArrayHashMapUnmanaged(impl.SPEL.SPEL) = .{},
    SSCR: std.StringArrayHashMapUnmanaged(impl.SSCR.SSCR) = .{},
    STAT: std.StringArrayHashMapUnmanaged(impl.STAT.STAT) = .{},
    WEAP: std.StringArrayHashMapUnmanaged(impl.WEAP.WEAP) = .{},
